...
original_prediction = imagenet_labels[adv_predicted.item()]

print(f"Original Prediction: {imagenet_labels[predicted.item()]}")
imshow(image_tensor[0], f"Original: {imagenet_labels[predicted.item()]}")
